...
Based on these results we can determine the confidence interval and point estimate for the proportion of ants from the upper nest segment. 

```{r}
calculate_CI(prob_mass, alpha=0.05)
```

The function generating Figure 5 repeates this procedure over the whole dataset.
